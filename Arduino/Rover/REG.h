...
#define REG_AMB_LINE_N    (16)
#define REG_AMB_LINE_E    (17)
#define REG_AMB_LINE_S    (18)
#define REG_AMB_LINE_W    (19)
#define REG_IR_COL_NE     (20)
#define REG_IR_COL_SE     (21)
#define REG_IR_COL_SW     (22)
#define REG_IR_COL_NW     (23)
#define REG_IR_LINE_N     (24)
#define REG_IR_LINE_E     (25)
#define REG_IR_LINE_S     (26)
#define REG_IR_LINE_W     (27)
#define REG_TRAILER       (28)
#define REG_MAX           (29)
