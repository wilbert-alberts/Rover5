...
public class MainWindow implements RoverClient.IRoverChanged {
	...
	private void initialize() {
		...
		centerPanel.setLayout(gbl_centerPanel);
						...
						gbc_lblColNW.weighty = 0.2;
						gbc_lblColNW.fill = GridBagConstraints.BOTH;
						...
						gbc_lblPosLeft.anchor = GridBagConstraints.NORTH;
						gbc_lblPosLeft.fill = GridBagConstraints.BOTH;
				...
				panel_2.setLayout(new CardLayout(0, 0));
						...
						GridBagConstraints gbc_lblColNE = new GridBagConstraints();
						gbc_lblColNE.weightx = 0.2;
						gbc_lblColNE.fill = GridBagConstraints.BOTH;
						gbc_lblColNE.insets = new Insets(0, 0, 5, 0);
						gbc_lblColNE.gridx = 2;
						gbc_lblColNE.gridy = 0;
						centerPanel.add(lblColNE, gbc_lblColNE);
								...
								gbc_lblPosRight.anchor = GridBagConstraints.NORTH;
								gbc_lblPosRight.fill = GridBagConstraints.BOTH;
						...
						GridBagConstraints gbc_lblColSW = new GridBagConstraints();
						gbc_lblColSW.weightx = 0.2;
						gbc_lblColSW.weighty = 0.2;
						gbc_lblColSW.fill = GridBagConstraints.BOTH;
						gbc_lblColSW.insets = new Insets(0, 0, 5, 5);
						gbc_lblColSW.gridx = 0;
						gbc_lblColSW.gridy = 2;
						centerPanel.add(lblColSW, gbc_lblColSW);
				
						lblColSE = new JLabel("SE");
						lblColSE.setHorizontalAlignment(SwingConstants.CENTER);
						lblColSE.setOpaque(true);
						GridBagConstraints gbc_lblColSE = new GridBagConstraints();
						gbc_lblColSE.insets = new Insets(0, 0, 5, 0);
						gbc_lblColSE.fill = GridBagConstraints.BOTH;
						gbc_lblColSE.gridx = 2;
						gbc_lblColSE.gridy = 2;
						centerPanel.add(lblColSE, gbc_lblColSE);
